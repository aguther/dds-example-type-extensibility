...
public class PayloadATypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Dds::Example::Type::PayloadA";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PayloadATypeSupport _singleton
    = new PayloadATypeSupport();
    ...
    */
    public static PayloadATypeSupport get_instance() {
        return _singleton;
    }

    public static PayloadATypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PayloadATypeCode.VALUE;
    }

    public Object create_data() {
        return PayloadA.create();
    }
    ...
    * <code>this</code> is not a <code>PayloadA</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PayloadA typedDst = (PayloadA) destination;
        PayloadA typedSrc = (PayloadA) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PayloadA typedSrc = (PayloadA) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.myString );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.myNumber);

            dst.writeString(typedSrc.myString,255);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PayloadA typedDst = (PayloadA) dst;
            typedDst.clear();      
            try{
                typedDst.myNumber = src.readInt();
                typedDst.myString = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PayloadA typedDst = (PayloadA) sample;
    ...
    int mask) {
        return new PayloadADataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PayloadADataReader(native_reader, listener, mask, this);   
    ...
    protected PayloadATypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PayloadATypeCode.VALUE,PayloadA.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PayloadATypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PayloadATypeCode.VALUE,PayloadA.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
